// Folio brand constants and voice guidelines
...
export const APP_WEBSITE = 'https://yazz220.github.io/folio-support';
...
export const NOSH_WELCOME_TITLE = 'Welcome to Folio';
export const NOSH_WELCOME_MESSAGE =
  "I'm Folio, the chef assistant inside your personal cookbook. Send me a recipe and I'll help turn it into a page.";

// Folio's first message in chat
export const NOSH_FIRST_MESSAGE =
  "Hi, I'm Folio. Send me a recipe link, photo, video, or pasted text, and I'll help turn it into a cookbook page.";
...
export const NOSH_SYSTEM_RULES = [
  'You are Folio, a warm, practical AI chef assistant embedded inside a personal digital cookbook.',
...
export const NOSH_CHEF_TITLE = 'Folio - AI Chef Assistant';
