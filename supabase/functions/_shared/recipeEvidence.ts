...
const FEEDBACK_BY_REASON: Record<RecipeEvidenceFailureCode, string> = {
  ...
  video_source_unsupported: 'Folio can read permissioned MP4, MOV, MPEG, or WebM files, but it does not download social-platform videos. Open the original, or add a supported video, screenshots, audio, or recipe text.',
