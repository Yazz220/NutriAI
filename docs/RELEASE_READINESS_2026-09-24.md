...
- Read the September 24 Apple Finance reply and rechecked App Store Connect. Finance asked for direct confirmation that the owner is outside the U.S. and repeated that the current U.S. legal-entity address is driving the tax setup. No account correction has been applied: the former U.S. address remains, Paid Apps is still Pending User Info, W-9 is still the only offered tax form, and the Bank of America update is still Processing.
...
2. Finance case `22149727`: the September 23 email says to activate the Paid Apps agreement using the current tax setup, then submit a corrected W-8/W-9. The actual available W-9 requires a U.S.-person certification under penalties of perjury. Based on the owner's stated non-U.S. status, that certification cannot be supplied truthfully. The September 24 reply asks, “Are you not in the US?” and notes that the U.S. legal-entity address is why the account says the owner is in the United States. Reply plainly that the owner is a Saudi citizen and resident outside the U.S., that the U.S. address is obsolete, and that Developer Support case `102960684367` is correcting it. Request a non-U.S. activation path that does not require a false W-9 certification.
