...
The creation Studio exposes name and cover color as the physical book's personalization choices. It does not expose named physical variants or material categories. The same live Nosh book updates directly as the user changes its title or color.
