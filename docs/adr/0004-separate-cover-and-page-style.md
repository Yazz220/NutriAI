...
Folio cookbook creation is a customization experience for one book, not a choice among products. A user names one cookbook, chooses how its physical cover looks, and separately chooses the visual language shared by the recipe pages inside it.
