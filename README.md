...
Nosh is a book-first Expo app for personal digital cookbooks. Users create styled cookbooks and capture recipes from links, pasted text, screenshots, public supported social-video links, or direct video files. Nosh extracts the structured recipe for reasoning, generates the complete designed recipe page, and places it directly into the appropriate book. The embedded AI chef answers questions from the active page and the user's wider recipe collection.
