...
export default function CoachScreen() {
  ...
  const { messages, sendMessage, performInlineAction } = useCoachChat();
          ...
          <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
            <View style={styles.composerRow}>
              <TextInput
                ...
                style={styles.input}
                onSubmitEditing={(e) => { const v = e.nativeEvent.text.trim(); if (v) { sendMessage(v); } }}
                returnKeyType="send"
              />
              <TouchableOpacity style={styles.sendBtn} onPress={() => sendMessage('Plan my day')}>
