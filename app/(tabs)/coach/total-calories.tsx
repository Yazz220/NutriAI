...
export default function TotalCaloriesDetail() {
      ...
      <ScrollView style={styles.content}>
        <View style={styles.card}>
          ...
          <View style={styles.breakdownContainer}>
            ...
            <View style={styles.breakdownRow}><Text style={styles.breakdownLabel}>From planned</Text><Text style={styles.breakdownValue}>{periodStats.fromPlanned} kcal</Text></View>
          </View>
...
const styles = StyleSheet.create({
  ...
  header: { padding: 16 },
  title: { fontSize: 20, fontWeight: Typography.weights.bold, color: Colors.text },
  ...
  breakdownPercent: { fontSize: 12, color: Colors.lightText },
});
